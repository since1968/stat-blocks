...
When you become a Skáld at 3rd level, you gain proficiency with medium armor and shields. You also become proficient in your choice of two of the following skills: Animal Handling, Medicine, Nature, Perception, or Survival.
...
You master the handaxe, battleaxe, and greataxe. You become proficient with these weapons if you are not already, and you gain the following benefits when using any of them:
...
* When a creature enters your spear’s reach, you can make a melee attack against it with your spear as a reaction. If the attack hits, the target takes an extra 1d8 piercing damage, or an extra 1d10 piercing damage if you wield the spear with two hands. You can’t use this ability if the creature used the Disengage action before moving.
